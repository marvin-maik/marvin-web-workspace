...
| ^ Design-Sync 2026-07-18 (angebot-Refresh auf alle LPs) | angebot.html-Refresh (Vollbreite --wrap, .guides Raster-Hairlines, .hero-grid Docket-Briefkopf, .sec-head Sektionslinien, .steps 01-04, Streichpreise 1.178/2.368, entkastete Garantie, Bon-Vergleich) auf die anderen LPs uebertragen. WARM (Muster 3 Koerper-Identitaet): karte/whatsapp/instagram.html NEU aus angebot.html kopiert, nur die 7 Kanal-Stellen getauscht (Kommentar/title/og:url/H1/Hero-Sub/CTA-H2/wa.me-Prefill), per diff byte-identischer Koerper verifiziert. KALT (Marvins Wahl "visuell mit-auffrischen"): kosten/eigentum/schnell = guides + sec-head-Linien + Streichpreise, schlanker Aufbau bleibt (KEIN Stack/hero-grid/dok, Garantie bleibt Kasten, Angle-Beweise unveraendert). Jetzt 7 LPs, alle styles.css?v=15. Browser-Check kosten+karte ok (guides/sec-head/Streichpreise rendern, Konsole sauber, mobil+desktop). _design.md nachgezogen (SYNC-Gap geschlossen, Inventar korrigiert). | Marvin: Design-Freigabe der 7 LPs. OFFEN (Copy, bewusst nicht angefasst): kalte Ad-LPs sagen im Ablauf-Schritt noch "30 Minuten" vs. 20 auf warm; Hero-CTA "Buch dir" duzt vs. sonst Sie (aus angebot geerbt) -> auf Wunsch je an einer Stelle angleichen. CAL-SWAP + DOMAIN-SWAP weiter offen. | Marvin: Design-Freigabe |
