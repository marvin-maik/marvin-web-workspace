...
| ROUTENWERK (Demo-Referenz fuer marvin-web, fiktives Studio) | Abflug-Welt im Build (Tafel, Paesse, Flip-Buttons, Scan, Passport, 3D-Globus+Flieger, 3D-Gate); CD-Handoff + neue Bildmarke fertig in handoff/ | Marvins Review auf echten Geraeten (bes. Flieger-Nase + Flip-Tempo) + Review Bildmarke/Guidelines (Einbau in Nav/Favicon erst nach Go); dann Animations-Schicht, qa-polish-Nachlauf, marvin-web-Verlinkung + Deploy | Marvin: Review |
