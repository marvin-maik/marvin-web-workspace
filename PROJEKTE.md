...
| LANDINGPAGES (eigenes Angebot, 3 Ad-LPs Kosten/Eigentum/Speed + warme Angebots-Seite) | Freigabe (Wireframes) 2026-07-16: Brief (product-marketing-context.md mit verbindlicher Review-Sperrliste) + struktur.md + 4 klickbare Lo-Fi-Wireframes in freigabe/ (index/lp-kosten/lp-eigentum/lp-speed/angebot), echte Umlaute in Copy, 0 Gedankenstriche, 1 h1/Seite, Demos (Count-up, Ladebalken-Rennen) im Browser getestet. ACHTUNG: Alt-Name "FutureGrowth" ist verboten, darf nirgends auftauchen (Marvin 2026-07-16). | Marvin: Wireframes freigeben + offene Entscheidungen (Sie/Du, Preise wie marvin-web, routenwerk als Beleg, Umzugs-Prozess, vertragliche Eigentums-Zusage, Formular ja/nein + Zustellweg, Angebots-Seite generisch/personalisiert, Highlights ja/nein). Danach design-scout -> Build. Ads erst NACH LPs texten (Message Match H1). | Marvin: Freigabe + Entscheidungsliste in freigabe/struktur.md |
