...
| ROUTENWERK (Demo-Referenz fuer marvin-web, fiktives Studio) | Abflug-Welt im Build (Tafel, Paesse, Flip-Buttons, Scan, Passport, 3D-Globus+Flieger, 3D-Gate) | Marvins Review auf echten Geraeten (bes. Flieger-Nase + Flip-Tempo); dann Animations-Schicht, qa-polish-Nachlauf, marvin-web-Verlinkung + Deploy | Marvin: Review |
