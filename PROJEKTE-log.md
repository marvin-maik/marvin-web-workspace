# MARVIN.WEB Log (Historie)

Vollstaendige Projekt-Historie. Der AKTUELLE Stand + offene Punkte leben im `_lotse` jedes Projekts; `PROJEKTE.md` ist der Einzeiler-Index. Hier nur die abgeschlossene Historie (grep-bar).
