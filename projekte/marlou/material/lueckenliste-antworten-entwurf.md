# Lueckenliste MARLOU: Antwort-Entwurf (fiktiv, zur Korrektur durch Marvin)

Stand: 2026-07-10. Status: ENTWURF, von Claude erfunden (Probeprojekt).
Nach Marvins Korrektur werden die finalen Antworten in product-marketing-context.md eingearbeitet.

1. **Domain:** marlou.travel als Hauptdomain (Branche im Namen, international lesbar),
   marlou.de defensiv mitregistrieren falls frei. E-Mail: hallo@marlou.travel.
2. **Preise:** PDF-Guides 29 EUR (7-10 Tage) / 39 EUR (14+ Tage). Beratung zweistufig:
...
6. **Socials:** instagram.com/marlou.travel und tiktok.com/@marlou.travel (Platzhalter).
7. **Design-Referenzen:** erledigt, Richtung A "Expeditionslogbuch" beschlossen.
8. **Lead Magnet:** bestaetigt: "Die 5 besten Abenteuer-Destinations fuer Paare" als
...
12. **Leistungsabgrenzung:** MARLOU plant, bucht aber nicht. Kunden buchen selbst ueber
    die mitgelieferten Links; auf Wunsch Buchungsbegleitung im Gespraech. Auf der
    Website klar kommunizieren (FAQ + Beratungs-Seite).
...
15. **Radikale Authentizitaet:** Noch Vision, keine belegten Kontakte. Auf der Website
    ...
    bestehendes Angebot.
16. **Louisa oeffentlich:** Ja, voller Name und Foto freigegeben (fiktiv).
17. **AGB/Widerruf:** Shop-Rechtspaket (IT-Recht Kanzlei oder Haendlerbund) fuer AGB +
    Widerruf digitale Produkte; Dieter Datenschutz fuer Impressum/Datenschutz/Cookies.
    Im Mockup: Platzhalter-Links im Footer.
18. **Affiliate:** Ja, Affiliate-Links in den PDF-Guides (Booking.com, GetYourGuide),
    Kennzeichnung im Guide auf der ersten Seite. Auf der Website selbst keine
    Affiliate-Links.
